...
print("नमस्ते , मैं आपका दोस्त गौरांक। आप मुझसे " + topic.split('\n')[0] + " के बारे में कुछ भी पूछ सकते है ।")
while True:
    query = input()

    if query == "नमस्ते":
        print('गौरांक: अलविदा दोस्त, आपका दिन शुभ हो।')
        break

    if query == "धन्यवाद":
        print("गौरांक: ये तो मेरा सौभाग्य है।")
        continue
